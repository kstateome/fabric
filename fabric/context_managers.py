...
from .utils import py3_nested as nested
import socket
import select
...
def remote_tunnel(remote_port, local_port=None, local_host="localhost",
    ...
    * ``remote_bind_address`` (optional) is the remote IP address to bind to
    ...
    def accept(channel, src_addr__src_port, dest_addr__dest_port):
        src_addr, src_port = src_addr__src_port
        dest_addr, dest_port = dest_addr__dest_port
